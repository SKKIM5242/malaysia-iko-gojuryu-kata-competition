              ...
              <div className="rounded-md border border-neutral-200 bg-neutral-50 p-3">
                ...
                <div className="mt-2 grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <IbanConfirmCheckbox id="bank_account_no_confirmed" defaultChecked={!!editing?.bank?.bank_account_no} />
                  </div>
                  <div className="sm:col-span-2">
          ...
          {participants.length === 0 ? (
            ...
            <FilterableTable
              ...
              columns={[
                ...
                { key: "home_address", label: "Home Address", width: 200 },
                { key: "city_town", label: "City / Town", width: 130 },
                { key: "postcode", label: "Postcode", width: 110 },
                { key: "home_country", label: "Country", width: 130 },
                { key: "school", label: "School", width: 170 },
                { key: "sensei", label: "Sensei", width: 170 },
                { key: "invitation_code", label: "Invitation Code", width: 170 },
                { key: "referral_source", label: "Referral", width: 190 },
