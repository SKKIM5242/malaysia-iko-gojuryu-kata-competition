...
export async function POST(request: Request, { params }: { params: Promise<{ kind: string }> }) {
  ...
  const template: CertificateTemplate = {
    ...
    frameOuterColor: b.frame_outer_color_override === true ? (typeof b.frame_outer_color === "string" ? b.frame_outer_color : null) : null,
    frameInnerColor: b.frame_inner_color_override === true ? (typeof b.frame_inner_color === "string" ? b.frame_inner_color : null) : null,
