# malaysia-iko-gojuryu-kata-competition

Malaysia IKO Goju-ryu Karate-do Kata competition management site — owner-controlled, publicly viewable, with paid participant registration and content publishing.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "302184928+SKKIM5242@users.noreply.github.com"
  git config user.name "SKKIM5242"
  ```
